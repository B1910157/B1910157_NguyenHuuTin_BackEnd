...
exports.update = async (req, res, next) => {
    ...
    try{
        ...
        return res.send({messege: "Contact was updated sucessfully"});
    }catch (error){
        return next(
...
exports.delete = async(req, res, next) => {
    try{
        ...
        return res.send({messege: "Contact was deleted successfully"});
...
exports.deleteAll = async(_req, res, next) => {
    try{
        ...
        return res.send({
            messege: `${deleteCount} contact were deleted successfully`,
        });
...
exports.findAllFavorite = async(_req, res, next) => {
    try{
        const contactService = new ContactService(MongoDB.client);
        const documets = await contactService.findFavorite();
        return res.send(documets);
    }catch (error){
